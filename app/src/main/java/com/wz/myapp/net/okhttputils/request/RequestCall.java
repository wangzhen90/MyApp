...
public class RequestCall {
    ...
    public OkHttpClient getClient() {
        if (readTimeOut > 0 || writeTimeOut > 0 || connTimeOut > 0 || (interceptors != null && !interceptors.isEmpty())) {
            ...
            OkHttpClient.Builder clientBuilder = ApiClient.getInstance().getOkHttpClient().newBuilder()
