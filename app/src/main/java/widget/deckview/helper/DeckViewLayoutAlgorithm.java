...
public class DeckViewLayoutAlgorithm<T> {
    ...
    public int mWithinAffiliationOffset;
    public int mBetweenAffiliationOffset;
    public HashMap<T, Float> mTaskProgressMap = new HashMap<T, Float>();
     ...
     */
    public void computeMinMaxScroll(ArrayList<T> data, boolean launchedWithAltTab,
...
//        Log.e("test","raw:"+mStackVisibleRect.bottom+",pAtBottomOfStackRect:"+pAtBottomOfStackRect);
